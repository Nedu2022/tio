    ...
    <div>
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white z-10">
          <h1 className="text-5xl text-nun font-bold mb-4">  Talk It Out With Betty</h1>
          <p className="text-lg mb-8">Discover the tools to navigate life's challenges with personalized
