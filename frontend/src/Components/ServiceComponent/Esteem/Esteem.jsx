...
import Estvideo from "../../../assets/esteem.mp4";
...
export default function EsteemBookingPage() {
    ...
    <>
      <section className="flex flex-col">
        <div className="fixed top-0 left-0 w-full z-50">
          <div className="m-3 lg:mx-0 text-primaryCoffee shadow-lg">
              <Header />
          </div>
        ...
        <div className="relative h-96 mt-28 lg:mt-40 lg:mx-10 opacity-0 animate-fadeIn transition-opacity duration-700">
          ...
          >
            <source src={Estvideo} type="video/mp4" />
          </video>
