    ...
    <>
      <section className="flex flex-col">
        ...
        <div className="relative h-96 mt-28 lg:mt-40 lg:mx-10 opacity-0 animate-fadeIn transition-opacity duration-700">
          ...
          <div className="absolute flex flex-col justify-center inset-0 bg-gradient-to-br from-black/80 to-transparent pointer-events-none">
            ...
            <p className="items-center justify-center flex text-white uppercase">
              ...
              <span>Family Psycology</span>
            </p>
          </div>
        </div>

        <section className="flex flex-col lg:flex-row gap-12 p-3 lg:mx-40 lg:pt-20 bg-white text-gray-800">
          <aside className="w-fit h-fit lg:w-1/3 space-y-4 border rounded-md p-4">
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative group overflow-hidden w-full text-left px-4 py-3 rounded-md border transition-colors duration-300
                ${
                  isActive
