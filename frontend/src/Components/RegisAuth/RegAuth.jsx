...
<div className="relative z-10 flex flex-row items-stretch justify-center w-full max-w-5xl p-10 h-full lg:h-[700px] bg-white rounded-lg shadow-lg">
  ...
  <div className="hidden lg:flex border-r-2 border-neutral-300 w-1/2 p-6 flex-col justify-center">
    <h1 className="text-3xl font-bold mb-4">WELCOME <span className="text-pink-500">TO</span> TIO</h1>
  ...
  <div className="flex flex-col items-center">
    ...
    <p className="mb-6 text-gray-600">Create An Account</p>
  </div>
...
<label htmlFor="terms" className="ml-2 text-sm">
  I agree to the terms of service
    ...
    <p className="mt-4 text-sm">
      Already a member? <Link to="/login" className="text-darkGray cursor-pointer">Login here</Link>
    </p>
  </div>
</div>
